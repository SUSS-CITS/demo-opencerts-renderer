...
export const transInfo: FunctionComponent<TemplateProps<SUSSTemplateTranscript>> = () => {
  return (
    <>
      <PrintWatermark />
      <div>
        ...
        <div className="container">
          ...
          <div className="row">
            <span className="textStyle">
              The University uses a credit unit (cu) system. The credit unit requirements are:
            </span>
          </div>
          <div className="row">
            <table className="w-100" border="1">
              <tbody>
                ...
                <tr>
                  <td className="tdStyleHeader tableHeaderStyle">Full time programmes</td>
                ...
                <tr>
                  <td className="tdStyleHeader tableHeaderStyle">Part time programmes</td>
          ...
          <div className="row">
            <span className="textStyle">
              This includes all the credit units that have been counted towards this qualification, including any credit
              transfer, subordinate award, and collaborative courses from approved institutions.
            </span>
          </div>
          <br />
          <div className="row">
          ...
          <div className="row">
            <span className="textStyle">The GPA is the average grade point of all courses taken by the student.</span>
          </div>
          ...
          <div className="row">
            ...
            <table className="w-100" border="1">
              <tbody>
                ...
                <tr>
                  <td className="tdMarksStyle textStyle">Two semesters Project/Capstone courses</td>
                  <td align="left" className="tdGradeStyle textStyle">
                    -
                  </td>
                  <td align="left" className="tdGradeStyle textStyle">
                ...
                <tr>
                  <td className="tdMarksStyle textStyle">
                    This is applicable only for Capstone Courses where an extension (IP) is granted
                  </td>
          ...
          <div className="row" style={{ marginTop: "45px" }}>
            <div className="col">
              <hr />
              <p>You may request additional academic transcript(s) online via www.suss.edu.sg</p>
            </div>
          </div>
        </div>
      </div>
